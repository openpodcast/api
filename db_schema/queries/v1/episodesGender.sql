WITH data as
(
    SELECT ep_guid,spa_facet, spa_gender_female,spa_gender_male,spa_gender_non_binary,spa_gender_not_specified
    FROM spotifyEpisodeAggregate JOIN spotifyEpisodeMetadata USING (episode_id) JOIN appleEpisodeMetadata ON (spotifyEpisodeMetadata.ep_name=appleEpisodeMetadata.ep_name)
