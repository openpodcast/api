...
CREATE TABLE appleEpisodeDetails (
  account_id INTEGER NOT NULL,
  episode_id BIGINT NOT NULL,
  aed_playscount INTEGER,
  aed_totaltimelistened BIGINT,
  aed_uniqueengagedlistenerscount INTEGER,
  aed_uniquelistenerscount INTEGER,
  aed_engagedplayscount INTEGER,
