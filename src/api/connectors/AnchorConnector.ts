...
import { AnchorDataPayload, ConnectorPayload } from '../../types/connector'
...
class AnchorConnector implements ConnectorHandler {
    ...
    async handleRequest(
        ...
        const anchorPayload = payload.data as AnchorDataPayload
        ...
        switch (anchorPayload.kind) {
            ...
            case 'audienceSize':
                validateJsonApiPayload(audienceSizeSchema, anchorPayload.data)
